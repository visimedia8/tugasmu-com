      ...
      <div className="flex flex-col gap-0 overflow-hidden rounded-2xl bg-white">
        ...
        <div className="p-6 flex flex-col gap-4">
          ...
          <ul className="flex flex-col gap-2 text-sm text-slate-600">
            ...
            <li className="flex items-center gap-2">
              <span className="material-symbols-outlined text-primary text-[16px]" style={{ fontVariationSettings: "'FILL' 1" }}>check_circle</span>
              Semua mode output (santai, formal, akademik)
            </li>
            <li className="flex items-center gap-2">
              <span className="material-symbols-outlined text-primary text-[16px]" style={{ fontVariationSettings: "'FILL' 1" }}>check_circle</span>
        ...
        <div className="px-6 pb-6 flex flex-col gap-3">
          <a
            href="/daftar"
            className="w-full text-center py-3 px-4 rounded-xl bg-primary text-white font-semibold text-sm shadow-md hover:opacity-90 transition-opacity active:scale-[0.98]"
          >
            Daftar Gratis dengan Google →
          </a>
          <button
            onClick={onClose}
            className="w-full text-center py-2.5 px-4 rounded-xl text-slate-500 text-sm hover:bg-slate-100 transition-colors"
          >
            Coba lagi besok
          </button>
        </div>
